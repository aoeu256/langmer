...
MyLog = (function() {
  function MyLog(_at_list) {
    this.list = _at_list != null ? _at_list : [];
  }
...
Sound.click = {
  play: function() {
    return Sound['click' + randItem([1, 2, 3])].play();
  }
};

StatDay = (function() {
  function StatDay(_at_date, _at_time, _at_new, _at_review) {
    this.date = _at_date != null ? _at_date : 0;
    this.time = _at_time != null ? _at_time : 0;
    this["new"] = _at_new != null ? _at_new : 0;
    this.review = _at_review != null ? _at_review : 0;
  }
...
WordList = (function() {
  function WordList(_at_title, _at_tabdata, _at_cols, _at_author, _at_nusers) {
    this.title = _at_title;
    this.tabdata = _at_tabdata;
    this.cols = _at_cols;
    this.author = _at_author;
    this.nusers = _at_nusers;
  }
...
Game = (function() {
  ...
  function Game(_at_words, _at_hanzi2data, _at_DEBUG, _at_cols) {
    this.words = _at_words;
    this.hanzi2data = _at_hanzi2data;
    this.DEBUG = _at_DEBUG != null ? _at_DEBUG : {};
    this.cols = _at_cols != null ? _at_cols : ['hanzi', 'pinyin', 'keyword'];
  ...
  Game.prototype.popupStories = function(it) {
    ...
    storyelement = (function(_this) {
      return function(text, author, date, rating) {
    ...
    $cont.trigger('create');
    this.call('get_stories', it, (function(_this) {
      return function(data, a, b) {
  ...
  Game.prototype.goal_start = function() {
    ...
    $('#finishbut').unbind('click').click((function(_this) {
      return function() {
  ...
  Game.prototype.start_start = function() {
    ...
    return $('#reviewbut').unbind('click').click((function(_this) {
      return function() {
  ...
  Game.prototype.updateSlot = function(tr) {
    ...
    if (state === "show" || state === "done") {
      ...
      for (_j = 0, _len1 = _ref.length; _j < _len1; _j++) {
        col = _ref[_j];
        _results.push(change(col + '_' + tr, this[col][tr], ''));
      }
      return _results;
    } else if (state === "match") {
      error2icon = {
  ...
  Game.prototype.gameloop = function(mode, round, error, wordsource, postsave) {
    var $but, col, datind, err, errors, prevhanz, swapDat, x, z, _j, _k, _l, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
    if (mode == null) {
      mode = 'show';
    }
    if (round == null) {
  ...
  Game.prototype.handleErrors = function() {
    ...
    this.errormode.forEach((function(_this) {
      return function(e, i) {
        var avg, ef, intv, q, timed, zi, _ref;
        if (e === 'correct' || e === 'wrong') {
          zi = _this.hanzi[i];
          _ref = getdefault(_this.interval, zi, [2.5, 0.0]), ef = _ref[0], intv = _ref[1];
          if (e === 'wrong') {
            q = 0;
  ...
  Game.prototype.drawTab = function(mode) {
    var $block, $but, $hed, $li, $lst, col2block, column, letters, pairs, uicls, _j, _k, _len1, _ref, _ref1;
    if (mode == null) {
      mode = 'show';
    }
    $('#game').empty();
  ...
  Game.prototype.enterTextMode = function() {
    ...
    $('.myinput').unbind('click').click((function(_this) {
      return function(e) {
        var row, _ref2;
    ...
    $('.myinput').unbind('change').change((function(_this) {
      return function(e) {
        var row, _ref2;
  ...
  Game.prototype._matcherror = function(zi) {
    ...
    if (((function() {
      ...
      this.unselectall();
      PTIME = 0;
      return this.pauselock(PTIME, (function(_this) {
        return function() {
  ...
  Game.prototype.updateButtons = function() {
    $("#game .item").unbind('click').click((function(_this) {
      return function(e) {
        var col, id, _ref;
        if (_this.locked) {
          return;
    ...
    return $(document).unbind('keypress').keypress((function(_this) {
      return function(e) {
        var q, _j, _ref;
  ...
  Game.prototype.reloadGet = function() {
    this.gameurl = '/';
    return $.getJSON(this.gameurl, (function(_this) {
...
test1 = function() {
  ...
  inner2 = function() {
    ...
    g.switchPage('start');
    $('#reviewbut').trigger('click');
    Globals.showclick = (function(_this) {
      return function() {
        var _l, _results1;
        _results1 = [];
    ...
    Globals.showclick();
    Globals.showclick();
    Globals.eachThing = (function(_this) {
      return function(i) {
        var d, err, keyword, kslot, pinslot, pinyin, rongslot, useslot, _ref;
    ...
    mything = (function(_this) {
      return function(i) {
        return g.errormode = randItem(['correct', 'wrong']);
      };
    })(this);
    return oeu.clickit = (function(_this) {
      return function() {
        var _l, _ref, _results1;
        _results1 = [];
  ...
  inner11 = function() {
    ...
    mh = 0;
    select = function(i) {
      var d, e, keyword, kslot, pinslot, pinyin, rongslot, useslot, _ref;
      eql(g, "g.select['hanzi']", i);
      try {
        _ref = g.hanzi2data[g.hanzi[i]], pinyin = _ref[0], keyword = _ref[1];
      } catch (_error) {
